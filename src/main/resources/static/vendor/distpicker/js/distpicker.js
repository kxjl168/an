...
function setArea(formele,response)
{
	...
	//模糊匹配
	var pval=$(formele).find("#province").find("option:contains('"+response.province+"')").val();
	$(formele).find("#province").val(pval);
    ...
    _createClass(Distpicker, [{
      ...
      value: function reset(deep) {
        if (!deep) {
          ...
          this.$province.attr("title","");
          this.$city.attr("title","");
          this.$district.attr("title","");
