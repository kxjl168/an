...
function InitQuery_item() {
	...
	$('#table_list_item').bootstrapTable({
		url : getRPath()+'/manager/tuserinfoMoney/list', // 请求后台的URL（*）
		method : 'post', // 请求方式（*）
        ...
        return dtxt;
			...
			},
		 {
			...
			},
			 {
				...
				valign : 'middle',
				  formatter: function (value, row, index) { 
				return getUserDepositTypeName(value);
				  }
			},
...

            {
                ...
                formatter: function (value, row, index) { 
                	if(value)
    				return value-row.todoMoney-row.doneMoney;
                	else 
                		return 0;
    				  }
            ...
            
            {
                ...
                events : window.PersonnelInformationEvents_item2
            }
		...
		"click #more" : function(e, value, row, index) {
	        ...
	        $("#myModal_item").modal();*/
			 ...
			 var uid=row.id;
		    	...
		    	var url='/manager/tuserinfoMoney/detail?uid='+uid;
