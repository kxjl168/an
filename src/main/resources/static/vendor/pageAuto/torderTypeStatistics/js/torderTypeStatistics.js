function test(){
	...
	var url = getRPath()+"/manager/torderTypeStatistics/test";
...
$(function() {
	...
	$("#btnSubmit_item").click(function() {
		...
		var url = getRPath()+"/manager/torderTypeStatistics/saveOrUpdate";
...
function InitQuery_item() {
	...
	$('#table_list_item').bootstrapTable({
		url : getRPath()+'/manager/torderTypeStatistics/typeStatisticsList', // 请求后台的URL（*）
		method : 'post', // 请求方式（*）
