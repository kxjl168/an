...
$(function () {
    ...
    $("#btnSubmit").click(function () {
        ...
        if (flag) {
            ...
            $.ajax({
                type: "post",
                url: getRPath() + '/manager/lockCompany/saveOrUpdate',
                data: data,
                async: false,
                dataType: "json",
...
function PersonnelInformationTable() {
    ...
    $('#table_list').bootstrapTable({
        url: getRPath() + '/manager/lockCompany/list', // 请求后台的URL（*）
        method: 'post', // 请求方式（*）
...
function modifyAndDeleteButton(value, row, index) {
    ...
    html += '<button id = "delete" type = "button"   data-tippy-content="删除" class = "tippy btn btn-danger"><i class="fa fa-trash"></i> </button>&nbsp;';
...
window.PersonnelInformationEvents = {
    "click #update": function (e, value, row, index) {
        $.ajax({
            type: "post",
            url: getRPath() + '/manager/lockCompany/getManager',
            data: {
                id: row.id
            },
            async: false,
    ...
    "click #delete": function (e, value, row, index) {
        var msg = "您真的确定要删除吗？";
        var url = getRPath() + "/manager/lockCompany/delete";
    ...
    "click #drop": function (e, value, row, index) {
        var msg = "您真的确定要废弃吗？";
        var url = getRPath() + "/manager/lockCompany/drop";
        cconfirm(msg, function () {
            $.ajax({
                type: "post",
                url: url,
    ...
    "click #reset": function (e, value, row, index) {
        var msg = "您真的确定要恢复吗？";
        var url = getRPath() + "/manager/lockCompany/reset";
        cconfirm(msg, function () {
            $.ajax({
                type: "post",
                url: url,
...
function doquery() {
    var opt = {
        url: getRPath() + "/manager/lockCompany/list",
        // silent : true
    };
