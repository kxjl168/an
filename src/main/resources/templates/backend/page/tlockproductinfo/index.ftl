  ...
  <div class='querytitle ' data-tippy-content="展开查询条件" >
                ...
                <form class="form-inline">
                    ...
                    <div class="form-group">
                        <label for="name" class="lb_text col-xs-5 control-label">产品名称:</label>
                    ...
                    <div class="form-group">
                        <label for="name" class="lb_text col-xs-5 control-label">产品型号:</label>

                        <div class="col-xs-7">
                            <input id="q_proType" type="text" name="q_proType"
                                   class="form-control inputtxt" placeholder=""
                                   aria-controls="dataTables-example">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-7">
                            <input id="q_company" type="text" name="q_company"
                                   class="form-control inputtxt" placeholder=""
                                   aria-controls="dataTables-example">
                        </div>
                    </div>
...
$(function(){
   ...
   $(".querytitle").click(function(){
	  ...
	  $(".querytitle")[0]._tippy.setContent($(".querytitle").attr("data-tippy-content"));
        ...
        <div class="mainbody">
            <div class="row">
                <div class="col-xs-5" style="margin-top: 16px;">锁企产品列表</div>
    ...
    <script src="${ctx}/vendor/pageAuto/tlockproductinfo/js/tlockproductinfo.js"></script>
    <script src="${ctx}/vendor/pageAuto/tlockproductinfo/js/tlockproductinfoform.js"></script>
    <script src="${ctx}/vendor/pageAuto/tlockproductinfo/js/tlockproductinfodetail.js"></script>
