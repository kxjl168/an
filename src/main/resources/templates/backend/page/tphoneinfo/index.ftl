  ...
  <div class='querytitle ' data-tippy-content="展开查询条件" >
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">接警手机手机号，也是接警手机（唯一约束）:</label>
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">接警手机名称:</label>
...
$(function(){
   ...
   $(".querytitle").click(function(){
	  ...
	  $(".querytitle")[0]._tippy.setContent($(".querytitle").attr("data-tippy-content"));
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">接警手机信息列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">接警手机信息列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/tphoneinfo/js/tphoneinfo.js"></script>
</body>
</html>