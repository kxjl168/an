...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">工单id:</label>

						<div class="col-xs-7">
							<input id="q_orderInfoId" type="text" name="q_orderInfoId"
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">申请人id:</label>

						<div class="col-xs-7">
							<input id="q_proposer" type="text" name="q_proposer"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">订单审核记录列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">订单审核记录列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/torderinfoaudit/js/torderinfoaudit.js"></script>
