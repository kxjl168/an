...
<div>
    ...
    <div class="modal-body">
        ...
        <div class="mainbody">
            <div class="row">
                <div class="col-xs-5" style="margin-top: 16px;">待回访工单列表</div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <span class="header">待回访工单列表</span>
                    </div>
...
<#include "../orderinfo_common/formPic.ftl">
    ...
    <script
            src="${ctx}/vendor/pageAuto/torderinfo_huif/js/torderinfo.js"></script>
