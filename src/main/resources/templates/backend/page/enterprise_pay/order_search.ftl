...
<form class="form-inline">
           ...
           <div id="companyIdView" class="form-group large">
                        <label for="name" class="lb_text col-xs-5 control-label">锁企名称:</label>

                        <div class="col-xs-7">
                            <select type="text" name="q_lockEnterpriseID" class="form-control"
                                    id="q_lockEnterpriseID" placeholder="所属锁企" maxlength="11">
                            </select>
                        </div>
                    </div>
  ...
  <div class="form-group large">
            ...
            <div class="col-xs-7">
                    ...
                    <option value="0" selected="selected">待结账</option>
        ...
        <div class="form-group">
            <label for="name" class="lb_text col-xs-5 control-label">完成时间:</label>
