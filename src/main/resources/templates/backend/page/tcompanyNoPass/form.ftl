                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group hide">
                                <label for="name" class="col-lg-3 control-label">所在地id，映射到t_address</label>
                                <div class="col-lg-9">
                                    <input type="text" name="companyAddressId"
                                           class="form-control" id="companyAddressId"
                                           placeholder="所在地id，映射到t_address">
                                    <p class="help-block"></p>
                                </div>
                            </div>
