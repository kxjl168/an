...
<body>
	...
	<div class="modal-body">
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-4" style="margin-top: 16px;">合伙人/代理人财务年度统计</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">合伙人/代理人财务年度统计</span>
					</div>
	...
	<#include "form.ftl">
		...
		<script src="${ctx}/vendor/pageAuto/companyStatistics/js/companyStatistics.js"></script>
</body>
</html>