...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group" >
						<label for="name" class="lb_text col-xs-3 control-label">查询分值:</label>
				...
				<form class=" form-inline margin-top-10">
					...
					<button type="button" id="btnQry" onclick="doOptionTableRefresh()"
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">锁匠评分奖励列表</div>
			</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">锁匠评分奖励列表</span>
					</div>
        ...
        <script src="${ctx}/vendor/pageAuto/tgradeMoney/js/tgradeMoney.js"></script>
        <script src="${ctx}/vendor/pageAuto/tgradeMoney/js/validator.js"></script>
