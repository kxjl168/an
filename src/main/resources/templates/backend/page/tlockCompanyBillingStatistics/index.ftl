...
<div>
    ...
    <div class="modal-body">
        ...
        <div class="mainbody">
            <div class="row">
                <div class="col-xs-4" style="margin-top: 16px;">发单量统计</div>
            ...
            <div class="row">
                ...
                <div id="MonthTj1" style="width:100%;height:450px;"></div>
            </div>
    ...
    <script src="${ctx}/vendor/pageAuto/tlockCompanyBillingStatistics/js/manager.js"></script>
