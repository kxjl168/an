        ...
        <input type="hidden" id="endTime"> 
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">锁匠类型:</label>

						<div class="col-xs-7">
							
								
								 <select name="q_userType" id="q_userType" class="form-control inputtxt">
                    <option value="">请选择</option>
                    <option value="1">签约锁匠</option>
                    <option value="2">合伙人</option>
                    <option value="4">合伙人下锁匠</option>
                      <option value="5">自营锁匠</option>
                        <option value="6">临时锁匠</option>
