...
<body>
	...
	<div>
		...
		<div class="modal-body">
			<div class="row">
				...
				<div class="queryclass collaps">
					...
					<div class='querytitle ' data-tippy-content="展开查询条件">
						<h5>
							查询条件 <i class="querytitlebtn fa fa-chevron-down"></i>
						</h5>
					...
					$(".querytitle").click(
							function() {
								...
								if ($(".queryclass").hasClass("collaps")) {
									...
									$(".querytitle").attr("data-tippy-content",
											"收起查询条件");
								} else {
								...
								$(".querytitle")[0]._tippy.setContent($(
										".querytitle").attr(
										"data-tippy-content"));
			...
			<div class="mainbody">
				<div class="row">
					<div class="col-xs-5" style="margin-top: 16px;">报警事件列表</div>
					...
					<div class="col-sm-12">
						...
						<div class="table-responsive" style="margin: 10px;">
							<table id="table_list_item"
								class="table table-noborder table-nohead  table-hover "></table>
						</div>
					</div>
				</div>
