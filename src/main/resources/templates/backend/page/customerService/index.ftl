...
<div>
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="queryclass collaps">
                ...
                <form class="form-inline" id="mform">
                    ...
                    <div class="form-group">
                        <label for="name" class="lb_text col-xs-5 control-label">客服人员:</label>

                        <div class="col-xs-7">
                            <input id="nickName" type="text" name="nickName"
                                   class="form-control inputtxt datepicker" placeholder="客服人员"
        ...
        <div class="mainbody">
            <div class="row">
                <div class="col-xs-4" style="margin-top: 16px;">客服服务</div>

                <div class="col-xs-1 col-xs-push-6" style="padding-top: 10px;">

                    <button type="button" class="btn btn-default" id="btnAdd_item">质量指标图示</button>
                </div>
            </div>
...
<#include "form.ftl">
    ...
    <script src="${ctx}/vendor/pageAuto/customerService/js/manager.js"></script>
