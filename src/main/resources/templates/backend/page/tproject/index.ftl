...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
                    ...
                    <div class="form-group" style="min-width: 300px;">
						<label for="name" class="lb_text col-xs-5 control-label">	工程名称:</label>

						<div class="col-xs-7">
							<input id="q_projectName" type="text" name="q_projectName"
                    ...
                    <div class="form-group" style="min-width: 300px;">
						<label for="name" class="lb_text col-xs-5 control-label">详细地址:</label>

						<div class="col-xs-7">
							<input id="q_addressDetail" type="text" name="q_addressDetail"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">工程表列表</div>
        ...
        <script src="${ctx}/vendor/pageAuto/tproject/js/tproject.js"></script>
        <script src="${ctx}/vendor/pageAuto/tproject/js/initPlugin.js"></script>
</body>
</html>