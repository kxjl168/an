<!-- 模态框（Modal） -->
<div class="modal fade" data-backdrop="static" id="myModal_item" style="    overflow-y:auto"
    ...
    <div class="modal-dialog">
                    ...
                    <div class="row">
                        ...
                        <#else>
                            <!-- <div class="form-group hide">
                                ...
                                <div class="col-lg-8">
                                    <select id="companySelect" class="selectpicker form-control inputtxt" data-live-search="true" data-style=""
                                            title="未选中任何项"></select>
                                    <input type="hidden" id="companyId" name="companyId">
                         ...
                         <div class="form-group">
                                <label for="name" class="col-lg-3 control-label">锁匠类型</label>
                                <div class="col-lg-8">
                                    <select id="userType" name="userType" class=" form-control inputtxt" data-live-search="true" data-style=""
                                            title="未选中任何项">
        ...
        <input type="hidden" id="q_districtCode"> 
                            ...
                            <div class="form-group jobareadiv">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <textarea  name="des" class="form-control" id="des" cols="20" rows="5" placeholder="备注标签"></textarea> 
                                    <p class="help-block"></p>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                  <button type="button" class="pull-left btn btn-warning" id="btnReAudit">
                        提交审核
                    </button>
