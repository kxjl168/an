		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModal_itemLabel">
					<span id="myModal_item_title">审核</span> 企业
				</h4>
			...
			<form id="mform_item2" name="mform_item2" class="form-horizontal"
				...
				<div class="modal-body">
							...
							<div class="form-group">
								...
								<div class="col-lg-9">
									<input type="text" name="companyName" class="form-control"
										id="companyName" readonly="readonly" placeholder="公司名称">
					...
					<select class="form-control" id="province" name="province" disabled="disabled"
						data-province="---- 选择省 ----">
					</select> <select class="form-control" id="city" name="city" disabled="disabled" data-city="---- 选择市 ----"></select>
							...
							<div class="form-group">
								...
								<div class="col-lg-9">
									<input type="text" name="companyAddressDetail"
										...
										readonly="readonly" placeholder="公司详细地址">
									<p class="help-block"></p>
								</div>
							</div>
