  ...
  <div class='querytitle ' data-tippy-content="展开查询条件" >
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">配置表value，非空:</label>

						<div class="col-xs-7">
							<input id="q_cvalue" type="text" name="q_cvalue"
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">备注说明本配置项的作用，非空:</label>
...
$(function(){
   ...
   $(".querytitle").click(function(){
	  ...
	  $(".querytitle")[0]._tippy.setContent($(".querytitle").attr("data-tippy-content"));
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">配置项列表</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/tconfig/js/tconfig.js"></script>
</body>
</html>