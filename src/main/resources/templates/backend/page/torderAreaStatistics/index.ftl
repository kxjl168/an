...
<div>
    ...
    <div class="modal-body">
        ...
        <div class="mainbody">
            <div class="row">
                <div class="col-xs-5" style="margin-top: 16px;">工单区域统计</div>
            </div>
            <div class="row">
...
<script
        src="${ctx}/vendor/pageAuto/torderAreaStatistics/js/torderAreaStatistics.js"></script>
</body>
</html>