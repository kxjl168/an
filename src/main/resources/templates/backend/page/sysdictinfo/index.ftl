  ...
  <div class='querytitle ' data-tippy-content="展开查询条件" >
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">类型   1案件类型  2案件等级:</label>
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">字典名称:</label>

						<div class="col-xs-7">
							<input id="q_dictName" type="text" name="q_dictName"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
...
$(function(){
   ...
   $(".querytitle").click(function(){
	  ...
	  $(".querytitle")[0]._tippy.setContent($(".querytitle").attr("data-tippy-content"));
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">系统字典表列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">系统字典表列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/sysdictinfo/js/sysdictinfo.js"></script>
</body>
</html>