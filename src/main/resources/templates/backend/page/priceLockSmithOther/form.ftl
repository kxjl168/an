        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModal_itemLabel">
                    <span id="myModal_item_title">添加</span> 锁匠费用
                </h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <select id="serverEditSelect" class="selectpicker" data-live-search="true"
                                            title="请选择服务类型">
                                        ...
                                        <option value="19,1" parentType="1">其他</option>
                                    ...
                                    <input type="hidden" id="serverEditType" name="serverType">
