...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">手机号码:</label>

						<div class="col-xs-7">
							<input id="q_mobile" type="text" name="q_mobile"
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">短信内容:</label>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">短信验证表列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">短信验证表列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/appsms/js/appsms.js"></script>
</body>
</html>