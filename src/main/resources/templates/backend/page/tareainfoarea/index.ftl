		...
		<div class="row">
			...
			<div class="col-lg-12 wzbj">
				...
				<h1 class="page-header">
					首页&nbsp;><span>&nbsp;片区对应的物理行政区域 1对多列表</span>
				</h1>
			</div>
		</div>
  ...
  <div class='querytitle ' data-tippy-content="展开查询条件" >
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">片区id:</label>

						<div class="col-xs-7">
							<input id="q_areaId" type="text" name="q_areaId"
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">行政区域id -t_area_district-id:</label>

						<div class="col-xs-7">
							<input id="q_districtId" type="text" name="q_districtId"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
...
$(function(){
   ...
   $(".querytitle").click(function(){
	  ...
	  $(".querytitle")[0]._tippy.setContent($(".querytitle").attr("data-tippy-content"));
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">片区对应的物理行政区域 1对多列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">片区对应的物理行政区域 1对多列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/tareainfoarea/js/tareainfoarea.js"></script>
</body>
</html>