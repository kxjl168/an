                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div id="dataTables-example_wrapper"
                             class="hidefirst dataTables_wrapper form-inline dt-bootstrap no-footer">
                            <div class="row ">
...
<#include "form.ftl">
<#include "form2.ftl">
    <script src="${ctx}/vendor/pageAuto/tlockcompany/js/tlockcompany.js"></script>
    <script src="${ctx}/vendor/pageAuto/tlockcompany/js/tlockcompanyDetail.js"></script>
