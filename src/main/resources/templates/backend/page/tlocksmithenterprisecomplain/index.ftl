...
<body>
	...
	<div class="modal-body">
            ...
            <div class="queryclass collaps">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">投诉锁企名:</label>

						<div class="col-xs-7">
                            <input id="q_enterpriseId" type="text" name="q_enterpriseId"
                                   class="form-control inputtxt" placeholder=""
                                   aria-controls="dataTables-example">						</div>
					</div>


					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">投诉内容:</label>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">锁企投诉列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">琐企投诉表列表</span>
					</div>
        ...
        <script src="${ctx}/vendor/pageAuto/tlocksmithenterprisecomplain/js/initPlugin.js"></script>
		<script src="${ctx}/vendor/pageAuto/tlocksmithenterprisecomplain/js/tlocksmithenterprisecomplain.js"></script>
</body>
</html>