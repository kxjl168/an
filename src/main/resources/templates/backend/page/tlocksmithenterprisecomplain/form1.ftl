<!-- 模态框（Modal） -->
<div class="modal fade" data-backdrop="static" id="myModal_item1"
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModal_itemLabel">
					<span id="myModal_item_title1">客服确认</span>
				</h4>

			</div>

			<form id="mform_item1" name="mform_item1" class="form-horizontal"
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal"
						id="close">关闭</button>
					<button type="button" class="btn btn-primary" id="btnSubmit_item1">
						提交更改</button>
				</div>
			</form>
