...
<div>
    ...
    <div class="modal-body">
        ...
        <div class="mainbody">
            <div class="row">
                <div class="col-xs-5" style="margin-top: 16px;">锁企费用列表</div>
...
<#include "form.ftl">
    ...
    <script src="${ctx}/vendor/pageAuto/price_lockcompany/js/price_lockcompany.js"></script>
    <script src="${ctx}/vendor/pageAuto/price_lockcompany/js/initPlugin.js"></script>
