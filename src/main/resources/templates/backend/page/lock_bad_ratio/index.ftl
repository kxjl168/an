...
<body>
	...
	<div class="modal-body">
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-4" style="margin-top: 16px;">锁匠月工单不良率统计</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">锁匠月工单不良率统计</span>
					</div>
	...
	<#include "form.ftl">
		...
		<script src="${ctx}/vendor/pageAuto/lockorderbadratio/js/lockorderbadratio.js"></script>
</body>
</html>