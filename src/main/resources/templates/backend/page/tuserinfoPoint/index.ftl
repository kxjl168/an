...
<body>
	...
	<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-xs-7">
							<input id="q_name" type="text" name="q_name"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example" maxlength="10">
						</div>
					</div>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">评分列表</div>
			</div>
        ...
        <!-- 模态框（Modal） -->
	<#include "index_history.ftl">

		<script
			src="${ctx}/vendor/pageAuto/tuserinfoPoint/js/tuserinfo.js"></script>
</body>
</html>