  ...
  <div class='querytitle ' data-tippy-content="展开查询条件" >
				...
				<form class="form-inline">
					...
					<div class="form-group">
						...
						<div class="col-xs-7">
							<input id="q_userInfoId" type="text" name="q_userInfoId"
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">详细内容，可空:</label>
...
$(function(){
   ...
   $(".querytitle").click(function(){
	  ...
	  $(".querytitle")[0]._tippy.setContent($(".querytitle").attr("data-tippy-content"));
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">锁匠变更日志列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">锁匠变更日志列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/tuserinfooperatelog/js/tuserinfooperatelog.js"></script>
</body>
</html>