  ...
  <div class='querytitle ' data-tippy-content="展开查询条件" >
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">单位id:</label>

						<div class="col-xs-7">
							<input id="q_unitId" type="text" name="q_unitId"
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">manager id:</label>

						<div class="col-xs-7">
							<input id="q_managerId" type="text" name="q_managerId"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
...
$(function(){
   ...
   $(".querytitle").click(function(){
	  ...
	  $(".querytitle")[0]._tippy.setContent($(".querytitle").attr("data-tippy-content"));
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">单位超级管理员 1对多列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">单位超级管理员 1对多列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/tunitinfomanager/js/tunitinfomanager.js"></script>
</body>
</html>