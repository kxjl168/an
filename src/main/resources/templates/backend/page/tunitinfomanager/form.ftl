		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModal_itemLabel">
					<span id="myModal_item_title">添加</span>	单位超级管理员 1对多
				</h4>
						...
						<div class="col-lg-12">
							...
							<input type="hidden" id="id" name="id">
									...
									<div class="form-group">
										<label for="name" class="col-lg-3 control-label">单位id</label>
									...
									<div class="form-group">
										<label for="name" class="col-lg-3 control-label">manager id</label>
