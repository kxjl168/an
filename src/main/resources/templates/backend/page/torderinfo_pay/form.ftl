                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="lockName"

                                           class="form-control" id="lockName" readonly="readonly"
                                           placeholder="锁匠id ">
                                    <p class="help-block"></p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="name" class="col-lg-3 control-label">工单打分： </label>

                                <div class="col-lg-9">
                                    <input type="text" name="serviceScore"

                                           class="form-control" id="serviceScore" readonly="readonly"
                            ...
                            <div class="form-group">
                                <label for="name" class="col-lg-3 control-label">锁匠总费用： </label>

                                <div class="col-lg-9">
                                    <input type="text" name="lockerTotalPrice"

                                           class="form-control" id="lockerTotalPrice" readonly="readonly"
                                    >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <textarea rows="5" class="form-control" cols="45" id="content" name="content"
