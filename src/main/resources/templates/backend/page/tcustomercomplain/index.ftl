...
<body>
	...
	<div class="modal-body">
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">客户投诉列表</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/tcustomercomplain/js/tcustomercomplain.js"></script>
</body>
</html>