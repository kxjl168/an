...
<div class="row margin-top-10">
        ...
        <div class="col-md-4 col-sm-2 box0">
         ...
         <div class="col-md-4 col-sm-2 box0">
            <div class="box1" style="background-color: #d4b491;"  onclick="toOrderHuifang()">
...
<div class="queryclass box2 margin-top-10 hide" >
   <div>
    ...
    <div class="row hide">
        ...
        <div class="col-md-3 col-sm-2 box0">
            <div class="box1" style="background-color: #3eb36f;"  onclick="toDoing()">
        ...
        <div class="col-md-3 col-sm-2 box0">
            <div class="box1" style="background-color: #ea9336;"  onclick="openurl(1,'')">
    ...
    <div class="row mt hide ">
        ...
        <div class="col-md-12 mb">
            ...
            <div class="row white-panel pn donut-chart" style="height: 426px;">
                ...
                <div class="row">
                    ...
                    <div id="MonthTj2" class="col-xs-11" style="height: 326px;"></div>
                </div>
            </div>

        </div>

        <div class="col-md-6 mb hide" id="mform1">
...
<script src="${ctx}/vendor/pageAuto/homePage/js/homePage3.js"></script>
