...
<div class="queryclass hide " style="min-height: 30px;">
    ...
    <div class="queryclass box2 margin-top-10 hide" >
        ...
        <div class="col-md-3 col-sm-2 box0">
            <div class="box1" style="background-color: #3eb36f;" onclick="userinfo()">
        ...
        <div class="col-md-3 col-sm-2 box0">
            <div class="box1" style="background-color: #ea9336;" onclick="pay()">
            ...
            <div class="white-panel pn donut-chart" style="height: 326px;">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-lg-3 control-label">请选择企业</label>
                        <div class="col-lg-4">
                            <select id="enterpriseSelect"  data-live-search="true" title="未选中任何项"></select>
...
<script src="${ctx}/vendor/pageAuto/homePage/js/homePage1.js"></script>
