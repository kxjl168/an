		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group" >
						<label for="name" class="lb_text col-xs-4 control-label">反馈人:</label>
                    ...
                    <div class="form-group" >
                        <label for="name" class="lb_text col-xs-4 control-label">手机号:</label>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">用户意见反馈表列表</span>
					</div>
