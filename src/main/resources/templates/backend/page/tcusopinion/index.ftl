...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group" >
						<label for="name" class="lb_text col-xs-3 control-label">反馈人:</label>
                    ...
                    <div class="form-group" >
                        <label for="name" class="lb_text col-xs-3 control-label">手机号:</label>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">客户意见反馈表列表</div>
			</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">客户意见反馈表列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/tcusopinion/js/tcusopinion.js"></script>
</body>
</html>