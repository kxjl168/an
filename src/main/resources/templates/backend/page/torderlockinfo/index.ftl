  ...
  <div class='querytitle ' data-tippy-content="展开查询条件" >
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">锁序列号，第几把:</label>

						<div class="col-xs-7">
							<input id="q_lockIndex" type="text" name="q_lockIndex"
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">订单编号，用于查询和前端展示(根据时间到秒+3位随机数):</label>
...
$(function(){
   ...
   $(".querytitle").click(function(){
	  ...
	  $(".querytitle")[0]._tippy.setContent($(".querytitle").attr("data-tippy-content"));
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">工单上多把锁的安装图片信息列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">工单上多把锁的安装图片信息列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/torderlockinfo/js/torderlockinfo.js"></script>
</body>
</html>