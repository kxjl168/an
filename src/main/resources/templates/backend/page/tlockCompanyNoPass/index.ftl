...
<div>
    ...
    <div class="modal-body">
        <div class="row">
            <div class="queryclass">
                <form class="form-inline">
                    ...
                    <div class="form-group">
                        <label for="number" class="lb_text col-xs-5 control-label">锁企电话:</label>
                        <div class="col-xs-7">
        ...
        <div class="mainbody">
            <div class="row">
                <div class="col-xs-5" style="margin-top: 16px;">锁企列表</div>
    ...
    <!-- 模态框（Modal） -->
<#include "form.ftl">
    <script src="${ctx}/vendor/pageAuto/tlockcompanynopass/js/tlockcompany.js"></script>
</body>
</html>