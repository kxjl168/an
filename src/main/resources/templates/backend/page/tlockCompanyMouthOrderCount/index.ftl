...
<div>
            ...
            <div class="queryclass collaps">
                ...
                <form class="form-inline" id="mform">
                    ...
                    <div id="companyIdView" class="form-group large">
                        <label for="name" class="lb_text col-xs-4 control-label">锁企名称:</label>
    ...
    <script src="${ctx}/vendor/pageAuto/tlockCompanyMouthOrderCount/js/manager.js"></script>
