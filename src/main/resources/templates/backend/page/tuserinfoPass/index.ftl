...
<body>
	...
	<#include "../user_common/lockquery.ftl">
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">已审核锁匠</div>
			</div>
  ...
  <script src="${ctx}/vendor/pageAuto/orderinfo_common/initPlugin.js"></script>
    ...
    <script src="${ctx}/vendor/pageAuto/tuserinfo/js/common/tuserArea.js"></script>
		...
		<script src="${ctx}/vendor/pageAuto/tuserinfoPass/js/tuserinfo.js"></script>
       ...
       +	'<@shiro.hasPermission name="user_to_auidt:clocker" >'   
           + '<button id = "clocker" type = "button" class = "btn btn-warning"><i class="fa fa-chat">变为合伙人下锁匠</i> </button>&nbsp;'
       	+'</@shiro.hasPermission>';
        	...
        	html+= '<button id = "reset" type = "button" class = "btn btn-success"><i class="fa fa-refresh">恢复</i> </button>&nbsp;';
      		...
      		html+= 
        			'<@shiro.hasPermission name="user_to_auidt:delete" >'   
