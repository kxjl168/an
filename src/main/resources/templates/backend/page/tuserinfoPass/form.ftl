                    ...
                    <div class="row">
                        ...
                        <#else>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="name" class="form-control" id="name" placeholder="姓名" maxlength="10">
                                    <p class="help-block"></p>
                                </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-8">
                                   <!--  <div id="distpicker" data-toggle="distpicker" class="in-line selectdist "> -->
                                                 ...
                                                 <select id="province1" name="province1" class=" form-control inputtxt" data-live-search="true" data-style="">
                    <option value="">请选择省份</option>
                </select>
                   <select id="city1" name="city1" class=" form-control inputtxt" data-live-search="true"
                        title="请选择城市" data-style="">
                </select>
                   <select id="district1" name="district1" class=" form-control inputtxt" data-live-search="true"
