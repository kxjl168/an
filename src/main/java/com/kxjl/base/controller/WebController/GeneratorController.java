...
import com.kxjl.base.mybatisMain.MybatisGenerator;
...
import com.kxjl.base.util.XmlUtils;
...
public class GeneratorController {
	...
	public String GeneratorList(PageCondition pageCondition, Generator g) throws IOException, ClassNotFoundException {
		...
		for (Generator generator : generators) {
			...
			if(generator.getTableName().contains("_"))
				 pojoName=TableNameUtil.getTFName(generator.getTableName().substring(generator.getTableName().indexOf("_")+1, generator.getTableName().length()));
			...
			// 匹配pageAndJs
			if (GeneratorUtils.matchReal(jsName, jsList)) {
