...
import com.kxjl.base.shiro.CustomCredentialsMatcher;
import com.kxjl.base.shiro.MyFormAuthenticationFilter;
import com.kxjl.base.shiro.MyShiroRealm;
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager, PermissionService permissionService) {
        ...
        if (null != permissions) {
            for (Map p : permissions) {
            	...
            	if(p.get("url")!=null&&!String.valueOf(p.get("url")).equals(""))
