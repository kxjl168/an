...
@Controller
@RequestMapping("/manager/enterpriseStatistics")
public class EnterpriseStatisticsController {
        ...
        public String manager(Model model) { return "/backend/page/enterpriseStatistics/index.ftl"; }



        @RequestMapping("/enterpriseList")
        @ManagerActionLog(operateDescribe = "锁企财务统计", operateFuncType = FunLogType.Query, operateModelClassName = OrderinfoMapper.class)
        @ResponseBody
        public String torderAreaStatistics(Orderinfo item, PageCondition pageCondition,HttpServletRequest request) {
            ...
            order = stasticService.selectEnterpriseStatistics(item);
    ...
    public void partnerFinancialStatisticsExcel(Orderinfo item, HttpServletResponse response, HttpServletRequest request) {
        ...
        List<Map> dataList = stasticService.selectEnterpriseStatistics(item);
